...
export default async function NewBlogPage() {
  ...
  // Als je niet bent ingelogd → redirect naar login
  if (!user) {
    redirect("/auth/login");
  }

  // Server Action voor bloggen
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-white to-blue-50 px-4 py-12 flex flex-col items-center">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <textarea
                name="content"
                required
                className="w-full border rounded-lg px-4 py-2 min-h-[200px] text-gray-700 shadow-sm focus:ring-2 focus:ring-blue-500 outline-none transition"
